...
pkgdatadir = $(datadir)/rama2met
pkgincludedir = $(includedir)/rama2met
pkglibdir = $(libdir)/rama2met
pkglibexecdir = $(libexecdir)/rama2met
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = rama2met.exe$(EXEEXT)
subdir = .
...
am_rama2met_exe_OBJECTS = module_rama2met.$(OBJEXT) \
	rama2metv2.$(OBJEXT)
rama2met_exe_OBJECTS = $(am_rama2met_exe_OBJECTS)
rama2met_exe_LDADD = $(LDADD)
AM_V_P = $(am__v_P_$(V))
...
am__v_FCLD_1 = 
SOURCES = $(rama2met_exe_SOURCES)
DIST_SOURCES = $(rama2met_exe_SOURCES)
...
STRIP = 
VERSION = v2.0
abs_builddir = /Users/agustin/proyectos/ram2metv2
abs_srcdir = /Users/agustin/proyectos/ram2metv2
...
pdfdir = ${docdir}
prefix = /Users/agustin/proyectos/ram2metv2
...
rama2met.exe$(EXEEXT): $(rama2met_exe_OBJECTS) $(rama2met_exe_DEPENDENCIES) $(EXTRA_rama2met_exe_DEPENDENCIES) 
	@rm -f rama2met.exe$(EXEEXT)
	$(AM_V_FCLD)$(FCLINK) $(rama2met_exe_OBJECTS) $(rama2met_exe_LDADD) $(LIBS)
